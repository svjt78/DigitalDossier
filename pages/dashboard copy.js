...
import { Edit2, Trash2, RefreshCw, AlertCircle, CheckCircle } from 'lucide-react';
          ...
          {['Blog', 'Book', 'Product'].map((cat) => {
            ...
            return (
              <button
                ...
                className={`
                  cursor-pointer aspect-square p-6 rounded-lg shadow-lg 
                    ...
                    <div className="flex items-center space-x-4 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link
                          ...
                          legacyBehavior
                        >
                          <a className="text-orange-400 hover:text-orange-300 hover:underline block truncate">
                            {item.title}
                          </a>
                        </Link>
                        {item.author && (
