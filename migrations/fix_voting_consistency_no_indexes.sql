...
-- VERSION WITHOUT INDEXES (Prisma handles indexes)
-- Run this after Prisma migration is successful
...
-- Create a consistency check function with proper data types
...
'Enhanced vote aggregation function with better error handling. Used by both API and triggers.';
