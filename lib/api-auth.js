...
export async function generateApiToken(name, permissions = ['upload'], expiresAt = null) {
...
export function hasPermission(apiToken, permission) {
  return apiToken?.permissions.includes(permission) || false;
}

export async function authenticateApiRequest(req, requiredPermission = 'upload') {
